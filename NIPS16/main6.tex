...
Clearly, when $\delta$ is small Hannan consistent policy exits for a large range of $c$. 

\begin{definition}[Weak Dominance]
	A SA-Problem with $K=2$ is said to satisfy weak dominance property if $c \notin [p_{12}-2\delta, p_{12}]$	
\end{definition}
