...
\begin{document}
	...
	\begin{abstract}
			...
			We then empirically verify this assumption on real datasets. We show that weak dominance is fundamental. We get linear regret if this condition is not satisfied and sublinear regret if it is. Our proof is based on reducing SAP to a special case of multi-armed bandit problems with side information.
