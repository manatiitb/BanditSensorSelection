...
\begin{minipage}{8cm}
		\centering
		\includegraphics[scale=0.4]{BSC_SD}
				\vspace{-.3cm}
		\caption{\footnotesize Regret under Strong Dominances}
\label{fig:BSC_SD}
	\end{minipage}
	\begin{minipage}{8cm}
		\centering
		\includegraphics[scale=0.4]{BSC_WD1}
				\vspace{-.3cm}
		\caption{\footnotesize Regret under varying levels of Weak Dominance}
\label{fig:BSC_WD}
	\end{minipage}
%	\begin{minipage}{4cm}
%		\centering
...
\begin{center}
	\begin{figure*}
		\begin{minipage}{8cm}
			\centering
			\includegraphics[scale=0.4]{Diabetes_WD1}
			\vspace{-.3cm}
		...
		\begin{minipage}{8cm}
			\centering
			%	\vspace{.2cm}
			\includegraphics[scale=0.4]{Heart_WD1}
			\vspace{-.3cm}
