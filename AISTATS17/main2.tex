...
cascaded sensor selection} problem. We cast it as a special case of stochastic partial monitoring problem (SPM), which is described in the appendix.
Later we will briefly describe extensions to tree-structures and contextual cases. %sensor selection. 
