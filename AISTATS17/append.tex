...
\section{Stochastic Partial Monitoring Problem (\cref{sec:Setup})}
...
\section{Proof of \cref{thm:tsdlearnable}}
\thmTSDLearnable*
...
\section{Proof of \cref{prop:gammadiff}}
\propGammadiff*
\begin{proof}
...
\section{Proof of \cref{prop:ilej}}
\propIlej*
\begin{proof}
...
\section{Proof of \cref{prop:jlei}}	
\propJlei*
	\begin{proof}
...
\section{Proof for \cref{sec:Learnability}}
In this section prove the observation made at the end of \cref{sec:Learnability}
\begin{prop}
	\label{prop:awdsound}
...
\section{Proof of \cref{prop:equivalence}}
\propEquivalence*
