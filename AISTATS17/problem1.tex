...
cascaded \ses} problem. We cast it as a special case of stochastic partial monitoring problem (SPM), which is described in the appendix. \todoc{Check this}
...
of costs.
While the learner knows $c$ from the start, $P$ is initially unknown. Henceforth we identify problem instance $\theta$ by $P$. 
